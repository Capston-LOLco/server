...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.findOne = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.findOne(user_id)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, {
                                data: user
    ...
    UserController.prototype.remove = function (user_id) {
