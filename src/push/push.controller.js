...
var PushController = /** @class */ (function () {
    function PushController(pushService) {
        this.pushService = pushService;
    }
    PushController.prototype.create = function (cam_id) {
    ...
    // }
    PushController.prototype.findAllByUserId = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.findAllByUserId(user_id)];
    ...
    ], PushController.prototype, "create");
    __decorate([
        (0, common_1.Get)(':user_id'),
        __param(0, (0, common_1.Param)('user_id'))
    ], PushController.prototype, "findAllByUserId");
